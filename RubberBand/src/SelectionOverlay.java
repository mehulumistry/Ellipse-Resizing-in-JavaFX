...
public class SelectionOverlay extends Region {
   ...
   // Ellipse selectionEllipse = new Ellipse();
    ...
    public SelectionOverlay(final Ellipse shape) {
        ...
        //dragHandlesVisible = dragHandlesVisible && (shape instanceof Ellipse);
...
//        if( selectionRectangleVisible) {
//            selectionRectangle.setCenterX(newBounds.getMinX()+newBounds.getWidth()/2);
//            selectionRectangle.setCenterY(newBounds.getMinY()+newBounds.getHeight()/2);
//            selectionRectangle.setRadiusX(newBounds.getWidth()/2);
//            selectionRectangle.setRadiusY(newBounds.getHeight()/2);
//        }
...
//                dragHandle.setY(newY);
                ...
                if( dragHandle == dragHandleN) {
                    ...
                    setHeight( rCell, (dragDelta.maxY - newY - radius)/2);
                   // rCell.relocate( dragDelta.minX, newY + radius);

                }
                else if( dragHandle == dragHandleNE) {

                    setWidth( rCell, (newX - dragDelta.minX + radius)/2);
                    setHeight( rCell, (dragDelta.maxY - newY - radius)/2);
                //    rCell.relocate( dragDelta.minX, newY + radius);

//                    setWidth( rCell, newX - dragDelta.minX);
//                    setHeight( rCell, dragDelta.maxY - newY );
//                    rCell.relocate( dragDelta.minX, newY );
                    ...
                    setWidth( rCell, (newX - dragDelta.minX + radius)/2);
                    setHeight( rCell, (newY - dragDelta.minY + radius)/2);
                    ...
                    setWidth( rCell, (dragDelta.maxX - newX - radius)/2);
                    setHeight( rCell, (newY - dragDelta.minY + radius)/2);
    ...
    private void setWidth( Ellipse node, double value) {


            Ellipse shape = (Ellipse) node;
            shape.setRadiusX(value);



    }

    private void setHeight( Ellipse node, double value) {
